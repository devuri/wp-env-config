...
class LocalEnvValTest extends TestCase
{
    ...
    public function test_wp_site_url() {
    ...
    public function test_app_tenant_id() {
        $expectedValue = null;
    ...
    public function test_is_multi_tenant_app() {
        $expectedValue = false;
    ...
    public function test_basic_auth_user() {
        $expectedValue = 'admin';
    ...
    public function test_basic_auth_password() {
        $expectedValue = 'demo';
    ...
    public function test_use_app_theme() {
        $expectedValue = false;
    ...
    public function test_wp_environment_type() {
        $expectedValue = 'debug';
    ...
    public function test_backup_plugins() {
        $expectedValue = false;
    ...
    public function test_send_email_change_email() {
        $expectedValue = false;
    ...
    public function test_sendgrid_api_key() {
        $expectedValue = '';
    ...
    public function test_sudo_admin() {
        $expectedValue = '0';
    ...
    public function test_wpenv_auto_login_secret_key() {
    ...
    public function test_web_app_public_key() {
    ...
    public function test_elementor_pro_license() {
        $expectedValue = '';
    ...
    public function test_avada_key() {
        $expectedValue = '';
    ...
    public function test_max_memory_limit() {
        $expectedValue = '256M';
    ...
    public function test_force_ssl_login() {
        $expectedValue = false;
    ...
    public function test_enable_s3_backup() {
        $expectedValue = false;
    ...
    public function test_s3_encrypted_backup() {
        $expectedValue = false;
    ...
    public function test_s3_backup_key() {
        $expectedValue = null;
    ...
    public function test_s3_backup_secret() {
        $expectedValue = null;
    ...
    public function test_s3_backup_bucket() {
    ...
    public function test_s3_backup_region() {
    ...
    public function test_s3_backup_dir() {
        $expectedValue = null;
    ...
    public function test_delete_local_s3_backup() {
        $expectedValue = false;
    ...
    public function test_db_password() {
    ...
    public function test_secure_auth_key() {
    ...
    public function test_logged_in_key() {
    ...
    public function test_nonce_key() {
    ...
    public function test_auth_salt() {
    ...
    public function test_secure_auth_salt() {
    ...
    public function test_logged_in_salt() {
    ...
    public function test_nonce_salt() {
