...
class HttpKernel
{
	...
	/**
	 * The site url and wp dir url.
	 */
	protected function site_url(): void
	{
		define('WP_REQUEST_URL', ($_SERVER['HTTPS'] ? 'https://' : 'http://') . $_SERVER['HTTP_HOST']);

		define( 'WP_HOME', WP_REQUEST_URL );
