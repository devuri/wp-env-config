...
class ScheduledEvent {
     ...
     */
    public function add_app_event() {
        add_action('init', array($this, 'schedule_app_event'));
    }
     ...
     */
    public function schedule_app_event() {
    ...
    public static function available_recurrences() {
        return array(
            'hourly' => __('Hourly', 'text-domain'),
            'twicedaily' => __('Twice Daily', 'text-domain'),
            'daily' => __('Daily', 'text-domain'),
            'weekly' => __('Weekly', 'text-domain'),
        );
    }
}
